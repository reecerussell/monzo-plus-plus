...
var fileDescriptor_fab68e5a84c56fd6 = []byte{
	...
	0x8b, 0x83, 0xd9, 0x4a, 0xfc, 0x5c, 0xbc, 0xae, 0xb9, 0x05, 0x25, 0x95, 0x41, 0xa9, 0xc5, 0x05,
	0xf9, 0x79, 0xc5, 0xa9, 0x46, 0x8e, 0x5c, 0xdc, 0x5e, 0xf9, 0x49, 0xc5, 0xc1, 0x10, 0x37, 0x08,
	0x19, 0x71, 0xb1, 0x80, 0xac, 0x15, 0x12, 0x82, 0xb8, 0x46, 0x0f, 0xc9, 0x0d, 0x52, 0x22, 0x50,
	0x31, 0x14, 0x03, 0x94, 0x18, 0x92, 0xd8, 0xc0, 0xc2, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff,
	0x9b, 0x3c, 0xa6, 0x46, 0xce, 0x00, 0x00, 0x00,
}
...
type JobsServiceClient interface {
	Push(ctx context.Context, in *PushRequest, opts ...grpc.CallOption) (*EmptyResponse, error)
}
...
func (c *jobsServiceClient) Push(ctx context.Context, in *PushRequest, opts ...grpc.CallOption) (*EmptyResponse, error) {
...
type JobsServiceServer interface {
	Push(context.Context, *PushRequest) (*EmptyResponse, error)
}
...
func (*UnimplementedJobsServiceServer) Push(ctx context.Context, req *PushRequest) (*EmptyResponse, error) {
